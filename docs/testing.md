...
DHU is the Auto rig (`scripts/dhu.sh` when written): Head Unit Server on `:5277`, faketime wrap, do **not** kill `:5277` / force-stop the Auto app. **Not a merge gate.** CI does not run DHU.
