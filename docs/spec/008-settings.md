...
| Auto-start on plug | bool | **false** | Settings (wired headset) |
| Auto-start in vehicle | bool | **false** | Settings (Android Auto / car mode; USB or wireless) |

Show app `versionName` (semver) in Settings.
