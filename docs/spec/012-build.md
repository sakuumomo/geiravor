...
| `versionName` | `0.1.0` |
| Cargo `version` | `0.1.0` |
| User-Agent | `Geiravor/0.1.0` |
| `versionCode` | `1` |

Keep the three semver strings identical (`000-product.md`).
...
GitHub Actions: Nix installer, `nix develop -c cargo test`, `nix develop -c ./gradlew :app:assembleDebug`. Debug signing only in 0.1.0.
