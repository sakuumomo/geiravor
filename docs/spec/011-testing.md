...
Fake UniFFI core. Cover pause→stop, FGS only while playing, notification permission path (compat), Auto browse hiding Queue when not AFK.
...
Phone: play/stop, volume, unplug, notification permission + notification, rotation, airplane, audio-focus interruption, AFK vs live DJ queue hide.
