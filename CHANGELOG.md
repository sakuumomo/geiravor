...
- Play enters FGS immediately (playback channel + connecting shade) so Icecast buffering no longer trips the foreground-service timeout. Mute sits next to volume on Now Playing. Listener count is labeled. Inner blocks use a 1.dp border and pad.
